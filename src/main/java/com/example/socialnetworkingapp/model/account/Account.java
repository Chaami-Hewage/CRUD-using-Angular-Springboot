...
public class Account implements UserDetails {
    ...
    @JoinColumn(name = "tag_id", referencedColumnName = "id") //specifies a one-to-one relationship with the Tag entity.
    private Tag tag;
    ...
    private List<Account> network = new ArrayList<>();
    ...
    public Account(AccountRole role, String firstName, String lastName, String email, String password, String phone, Tag tag) {
        this.role = role;
    ...
    public Account(AccountRole role, String firstName, String lastName, String email, String password, String phone, Tag tag, String url) {
        this.role = role;
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
